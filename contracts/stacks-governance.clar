;; Title: Stacks Governance Protocol: Decentralized Fund Management on Bitcoin's Layer 2
;; Summary: A trustless DAO framework enabling community-controlled treasury management through proposal voting
;; Description: 
;; The Stacks Governance Protocol (SGP) is a Bitcoin-compliant decentralized autonomous organization platform
;; built on Stacks Layer 2. It enables collective management of digital assets through:
;; - STX deposit system with time-locked withdrawals
;; - Proposal creation with customizable funding requests
;; - Weighted voting system based on token holdings
;; - Secure execution of approved transactions
;; - Time-bound governance processes anchored to Bitcoin blocks
;;
;; Features Bitcoin-finalized security with Stacks Layer 2 efficiency, implementing:
;; 1. Minimum 24h voting durations (144 blocks) with 14-day maximum
;; 2. MicroSTX-denominated governance tokens
;; 3. Anti-sybil attack protections through deposit locking
;; 4. Transparent proposal lifecycle tracking
;; 5. Immutable vote recording with double-spend prevention
;;
;; Designed for regulatory-compliant decentralized organizations needing auditable,
;; on-chain governance for treasury management.
